<script>
  ...
  <nav data-sveltekit-reload class="w-full flex gap-3 px-4 py-2 bg-gray-500 text-white">
    ...
    <div class="dropdown  md:relative">
      ...
      {#if dropdownOpen}
        <div data-sveltekit-reload class="dropdown-menu grid grid-cols-2 md:grid-cols-1 absolute left-0 mt-2 w-full md:w-60 bg-white border border-gray-200 divide-y divide-gray-100 text-black z-20">
